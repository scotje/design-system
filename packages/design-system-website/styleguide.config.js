  ...
  sections: [
    ...
    },
    {
      ...
      ignore: [
        ...
        '**/modal/ModalTitle.js',
        '**/page-header/PageHeaderActions.js',
        '**/page-header/PageHeaderExtras.js',
        '**/page-header/PageHeaderHeader.js',
        '**/page-header/PageHeaderMetadata.js',
        '**/page-header/PageHeaderSubHeader.js',
        '**/page-header/PageHeaderTitle.js',
        '**/page-header/PageHeaderTitleSupplement.js',
